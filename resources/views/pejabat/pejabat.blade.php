                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            ...
                            <!-- Card kedua - Pengajuan Dalam Proses -->
                            <div class="col-lg-3 col-md-3">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        <div class="card-title d-flex align-items-start justify-content-between">
                            ...
                            <!-- Card ketiga - Pengajuan Disetujui -->
                            <div class="col-lg-3 col-md-3">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        <div class="card-title d-flex align-items-start justify-content-between">
                                        ...
                                        <span class="d-block mb-1">Pengajuan Yang Disetujui</span>
                                        @php
                            ...
                            <!-- Card keempat - Pengajuan Tidak Disetujui -->
                            <div class="col-lg-3 col-md-3">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        <div class="card-title d-flex align-items-start justify-content-between">
                                        ...
                                        <span class="fw-medium d-block mb-1">Pengajuan Tidak Disetujui</span>
                                        @php
